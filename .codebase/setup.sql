...
values
(0, true, 127, 32767, 2147483647, 9223372036854775807, 99999999999999999999999999999999999999, -0, -0, "1900-01-01", "1800-11-20 12:34:56", 9999999.57, 999999999999999.568, 9999999999999999999999999999999999.5679, "c_char:name0", "c_varchar:name0"),
...
values
(0, 0, true, 127, 32767, 2147483647, 9223372036854775807, 99999999999999999999999999999999999999, -0, -0, "1900-01-01", "1800-11-20 12:34:56", 9999999.57, 999999999999999.568, 9999999999999999999999999999999999.5679, "c_char:name0", "c_varchar:name0"),
...
values
( 0, 1, "2024-05-01",  0, true, 127, 32767, 2147483647, 9223372036854775807, 99999999999999999999999999999999999999, -0, -0, "1900-01-01", "1800-11-20 12:34:56", 9999999.57, 999999999999999.568, 9999999999999999999999999999999999.5679, "c_char:name0", "c_varchar:name0"),
...
values
( "2024-05-01", 1,  0,  0, true, 127, 32767, 2147483647, 9223372036854775807, 99999999999999999999999999999999999999, -0, -0, "1900-01-01", "1800-11-20 12:34:56", 9999999.57, 999999999999999.568, 9999999999999999999999999999999999.5679, "c_char:name0", "c_varchar:name0"),
...
-- read and write test
CREATE TABLE `tb_read_write_all_type_unique` (
  `rowId` int(11) NOT NULL COMMENT "",
  `rowId2` int(11) NOT NULL COMMENT "",
  `c_boolean` BOOLEAN NULL COMMENT "",
  `c_tinyint` TINYINT NULL COMMENT "",
...
CREATE TABLE `tb_read_write_all_type_primary` (
  `rowId` int(11) NOT NULL COMMENT "",
  `rowId2` int(11) NOT NULL COMMENT "",
  `c_boolean` BOOLEAN NULL COMMENT "",
  `c_tinyint` TINYINT NULL COMMENT "",
